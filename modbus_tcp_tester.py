...
# Creating the data class for the configfile
...
parser.add_argument("--configfile_path", required=False, default="devices/configs/string/test.yaml")

args = parser.parse_args()

def get_device_config(client_config_path):
    # Getting the information about the device
    configfile_path = Path.cwd().joinpath(client_config_path)
    yaml = YAML()
...
if __name__ == "__main__":
    try:
        ...
        modbusclient = check_connection(device.ip, port=device.port)
